...
// ----------------------------------------------------------------------------
//                                                                       МЕТОД
// начальная настройка подключения WiFi. печать отчёта в UART.
// ----------------------------------------------------------------------------
...

{
  ...
  pinMode(LED, OUTPUT);          // светодиод. режим OUTPUT
  pinMode(BUTTON, INPUT_PULLUP); // кнопка. режим INPUT_PULLUP

  esp8266_setup(); // начальная настройка подключения WiFi. печать отчёта в UART.
}
